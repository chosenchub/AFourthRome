...
NGame = {
	...
	EVENT_TIMEOUT_DEFAULT = 30,						-- Default days before an event times out if not scripted
...
NDiplomacy = {
	...
	BASE_TRUCE_PERIOD = 90,							-- Base truce period in days.
	TRUCE_PERIOD_AFTER_KICKING_FROM_FACTION = 120,				-- Truce period after kicking someone from faction in days.
	NUM_DAYS_TO_ENABLE_KICKING_NEW_MEMBERS_OF_FACTION = 180,			-- Number of days before being able to kick a new member of faction 
	NUM_DAYS_TO_ENABLE_REINVITE_KICKED_NATIONS = 180,			-- Number of days before being able to re invite a kicked nation to your faction
	BASE_NEGATIVE_OPINION_AFTER_BEING_KICKED = 60,				-- Negative opinion that will be received after kicking a nation
	...
	BASE_PEACE_PUPPET_FACTOR = 0,					-- Base factor for puppet in %.
	BASE_PEACE_LIBERATE_FACTOR = 0,				-- Base factor for liberate in %.
	...
	BASE_STAGE_COUP_DAILY_PP = 15.0,				-- Daily pp cost for staging a coup
	BASE_STAGE_COUP_TOTAL_COST = 300, 				-- Equipment consume factor for stage coup.
	...
	TENSION_CAPITULATE = 1.25,						-- Scale of the amount of tension created by a countries capitulation.
	...
	MONTHLY_LEASED_IC_DECAY = 15,					-- How much of leased equipment is being "forgot" each month
...
NCountry = {
	...
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 0.5, -- Reduce enemy national war support on nuking a province, the value scales with infrastructure up to this number
	...
	POLITICAL_POWER_CAP = 500.0,					-- Max amount of political power country should have
	...
	STATE_OCCUPATION_COST_MULTIPLIER = 0.11,		-- Multiplier for state value to PP cost for occupation
...
NAI = {
	...
	RESEARCH_NAVAL_DOCTRINE_NEED_GAIN_FACTOR = 2, -- Multiplies value based on relative naval industry size / country size.
	RESEARCH_AIR_DOCTRINE_NEED_GAIN_FACTOR = 2, -- Multiplies value based on relative number of air base / country size.
	...
	RESEARCH_BONUS_FACTOR = 50, 				-- To which extent AI should care about bonuses to research
	MAX_AHEAD_RESEARCH_PENALTY = 2,             -- max ahead of tiem penalty ai will pick ever
	RESEARCH_AHEAD_OF_TIME_FACTOR = 100.0, 		-- To which extent AI should care about ahead of time penalties to research
	...
	PRODUCTION_EQUIPMENT_SURPLUS_FACTOR = 1.5,	-- Base value for how much of currently used equipment the AI will at least strive to have in stock
	...
	MAX_UNITS_FACTOR_INVASION_ORDER = 10.0,				-- Factor for max number of units to assign to naval invasion orders
	DESIRED_UNITS_FACTOR_INVASION_ORDER = 1.0,			-- Factor for desired number of units to assign to naval invasion orders
	MIN_UNITS_FACTOR_INVASION_ORDER = 5.0,				-- Factor for min number of units to assign to naval invasion orders
	...
	MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.8,			-- Cancel unit production if below this to get resources out to units in the field
	MIN_MANPOWER_TO_BUILD_UNITS = 0.8,					-- Cancel unit production if below this to get resources out to units in the field
	...
	LAND_DEFENSE_INTERSEPTORS_PER_BOMBERS = 2.0,		-- Amount of air interceptor planes requested per enemy plane
